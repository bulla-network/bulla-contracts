...
import BullaGroupArtifact from "../../artifacts/contracts/BullaV1.sol/BullaGroup.json";
import BullaClaimArtifact from "../../artifacts/contracts/BullaV1.sol/BullaClaim.json";
import { BullaManager, BullaManagerInterface } from "../../typechain/BullaManager";
...
import  {ethers, BigNumber, utils, BytesLike, Wallet, providers, Contract} from "ethers";
